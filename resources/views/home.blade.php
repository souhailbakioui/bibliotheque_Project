...
<html lang="en">
    ...
    <!-- Site CSS -->
    <link rel="stylesheet" href="{{ asset('/resources/css/animate.css')}}" type="text/css">  
    <link rel="stylesheet" href="{{ asset('/resources/css/hero-slider.css')}}" type="text/css">    
    <link rel="stylesheet" href="{{ asset('/resources/css/swiper.min.css')}}" type="text/css">    
    <link rel="stylesheet" href="{{ asset('/resources/css/bootstrap-select.min.css')}}" type="text/css">    
    <link rel="stylesheet" href="{{ asset('/resources/css/prettyPhoto.css')}}" type="text/css">    
    <link rel="stylesheet" href="{{ asset('/resources/css/owl.carousel.css')}}" type="text/css">    
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{URL::asset('/resources/css/custom.css')}}" type="text/css">
...
<body class="app_version" data-spy="scroll" data-target="#navbarApp" data-offset="98">
    ...
    <!-- LOADER -->
    <div id="preloader">
        <img class="preloader" src="{{asset('resources/images/loaders/loader-app.gif')}}" alt="">
    </div><!-- end loader -->
    <!-- END LOADER -->
    <header class="header header_style_01">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.html"><img src="{{ asset('resources//images/logos/logo-app.png')}}" alt="image"></a>
		...
		<ul class="cd-hero__slider">
			<li class="cd-hero__slide cd-hero__slide--selected js-cd-slide">
				...
				<div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
					<img src="{{ asset('resources/uploads/app_iphone_01.png')}}" class="img-fluid" alt="tech 1">
				</div> <!-- .cd-hero__content -->
			</li>
			...
			<!--	<div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
					<img src="resources/resources/uploads/app_iphone_02.png" class="img-fluid" alt="tech 1">
				</div> .cd-hero__content 
			</li>

			<li class="cd-hero__slide js-cd-slide">
				<div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
					<img src="resources/resources/uploads/app_iphone_01.png" class="img-fluid" alt="tech 2">
				</div>  .cd-hero__content 
			...
			<li class="cd-hero__slide js-cd-slide">
				<div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
					<img src="resources/uploads/app_iphone_02.png" class="img-fluid" alt="tech 2">
				</div>  .cd-hero__content 
			...
			<li class="cd-hero__slide js-cd-slide">
				...
				<div class="cd-hero__content cd-hero__content--half-width cd-hero__content--img">
					<img src="resources/uploads/app_iphone_01.png" class="img-fluid" alt="tech 1">
				</div>  .cd-hero__content 
			</li>
		</ul> .cd-hero__slider 
	...
	<div id="about" class="section wb">
		<div class="container">
			...
			<div class="row align-items-center">
				<div class="col-lg-7 col-md-6">
					<div class="about-left">
						<img src="resources/uploads/about-01.png" class="img-fluid" alt="" />
					</div>
				</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-7 col-md-6">
					<div class="about-left">
						<img src="resources/uploads/about-02.png" class="img-fluid" alt="" />
					</div>
				</div>
			</div>
            ...
            <div class="row align-items-center text-center">
               ...
               <!-- <div class="col-md-6 iphones">
                    <div class="text-center image-center">
                        <img src="resources/uploads/iphones.png" alt="" class="img-fluid wow fadeInUp">
                    </div>
                </div>
            </div> end row 
        </div> end container 
...
-->
    ...
    <div id="team" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>New Books</h3>
                <p class="lead">Discover the latest books including trending new book releases & best sellers in 2021<br> Browse the newest fiction books, nonfiction books, kids & YA books</p>
            </div><!-- end title -->

            <div class="row">
                
			
				<div class="col-3 col-md-3 "><a class="o" data-content='_romacy' href="#">ROMACY</div>
				<div class="col-3 col-md-3 "><a class="o" data-content='_Action' href="#">ACTION</div>
				<div class="col-3 col-md-3 "><a class="o" data-content='_Drama' href="#">DRAMA</div>
				<div class="col-3 col-md-3 "><a class="o" data-content='_romacy' href="#">HISTORY</div>
			...
			<div class="row _romacy" style='width:100%;'>
			
				<div class="col-12 col-sm-6 col-md-3 col-sm-2 products">
				<div class="product_img">
						<img src="https://secure.syndetics.com/index.aspx?type=xw12&client=claplib&upc=&oclc=&isbn=9781368022255/LC.JPG">
					</div>
			...
			<div class="row _Action" style='width:100%;'>
			
			<div class="col-12 col-sm-6 col-md-3 col-sm-2 products">
			<div class="product_img">
					<img src="https://secure.syndetics.com/index.aspx?type=xw12&client=claplib&upc=&oclc=&isbn=9780425290804/LC.JPG">
				</div>
				<div class="product_link">
					<a href="ssssssssssss#">
						<p3>BOOK FOR YOU</p3>
    ...
    <div class="parallax section stats-box" style="background-image:url('resources/uploads/ben_img_2.jpg');">
        <div class="container">
...
Pourqoi Cette SiteWeb							</a>
	...
	<script type="text/javascript" src="{{ asset('resources/js/swiper.min.js')}}"></script>
